...
app.post("/save", (request, reply) => {
  ...
  body.firstname = body.firstname.replace(regex, "");
  body.lastname = body.lastname.replace(regex, "");

  //remove html tags
  const regex2 = /<[^>]*>?/gm;
  body.firstname = body.firstname.replace(regex2, "");
  body.lastname = body.lastname.replace(regex2, "");
